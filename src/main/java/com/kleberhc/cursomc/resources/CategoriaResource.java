...
public class CategoriaResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody CategoriaDTO objDto){ // RequestBody faz o JSON ser convertido em obj JAVA
	...
	public ResponseEntity<List<CategoriaDTO>> findAll() {
		...
		// Converte a lista Categoria para listaDTO Categoria
