...
import com.kleberhc.cursomc.services.PedidoService;
...
public class PedidoResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody Pedido obj){ // RequestBody faz o JSON ser convertido em obj JAVA
